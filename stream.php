      ...
      <div class="main-container show">
        <div class="stream-area">
          <div class="video-stream">
            ...
            <iframe id="my_video_1" class="video-js vjs-default-skin dvid" width="640px" height="267px" controls preload="none" src="<?php echo $post_content; ?>" scrolling="no" frameborder="0" allowfullscreen="true"></iframe>
