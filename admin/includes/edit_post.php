<?php
    ...
    if (isset($_POST['update_post'])) 
    {
       ...
       $query = "UPDATE posts SET post_category_id = $post_category_id, post_title = '$post_title', 
        ...
        echo "<p class='text-center text-success bg-success'>Post Updated. <a href='../stream.php?v_id=$the_get_post_id'> View Post</a> Or <a href='posts.php'>Edit More Posts</a></p>";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="post_content">Video Src</label>
        <input name="post_content" class="form-control" value="<?php echo strip_tags($post_content); ?>"></input>
    </div>
