<?php
    ...
    //    $post_comment_count  = 4;
       ...
       $query = "INSERT INTO posts(post_category_id, post_title, post_user, post_date, post_image, 
        ...
        echo "<p class='text-center text-success bg-success'>Post Created. <a href='../stream.php?p_id=$the_get_post_id'> View Post</a> Or <a href='posts.php'>Edit More Posts</a></p>";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="url" name="post_content" class="form-control"></input>
    </div>
